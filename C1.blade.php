...
<html lang="en">
  ...
  <body>
   ...
   <div class="excel"><h3 style="margin: 5px 0px 20px 0px;">Excel Title<a href="{{ asset('asset\excel\Book1.xlsx') }}" download class="excelbutton">Download</a></h3></div>
    ...
    @endif
    <form action="{{ route('C1.upload') }}" method="POST" enctype="multipart/form-data">
        @csrf
 ...
 <!-- Button to show all uploaded files -->
      <a href="{{ route('C1') }}" class="v" >Show All Uploaded Files</a><br><br>
            ...
            <tbody>
                @foreach($files as $file)
                    <tr>
                        ...
                        <td><a href="{{ route('C1.view', ['id' => $file->id]) }}" class="v">View</a></td>
                        <td><a href="{{ route('C1.download', ['id' => $file->id]) }}" class="v">Download</a></td>
                        <td>
                            <form action="{{ route('C1.delete', ['id' => $file->id]) }}" method="POST">
                                @csrf
                                @method('DELETE')

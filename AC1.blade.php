  ...
  <main>
    ...
    <main-content>
      <div class="container">
        ...
        <a href="{{ route('AC1.index') }}" class="v">All uploaded files</a>
        <br><br>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="{{ route('AC1.view', ['id' => $file->id]) }}" class="v">View</a></td>
              <td><a href="{{ route('AC1.download', ['id' => $file->id]) }}" class="v">Download</a></td>
              <td>
                <form action="{{ route('AC1.delete', ['id' => $file->id]) }}" method="POST">
                  @csrf
                  @method('DELETE')

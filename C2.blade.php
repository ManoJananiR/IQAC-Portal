...
<html lang="en">
  ...
  <body>
   ...
   <div class="excel"><h3 style="margin: 5px 0px 20px 0px;">Excel Title<a href="{{ asset('asset\excel\Book1.xlsx') }}" download class="excelbutton">Download</a></h3></div>
    ...
    @endif
    <form action="{{ route('C2.upload') }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <tbody>
                @foreach($files as $file)
                    <tr>
                        ...
                        <td><a href="{{ route('C2.view', ['id' => $file->id]) }}" class="v">View</a></td>
                        <td><a href="{{ route('C2.download', ['id' => $file->id]) }}" class="v">Download</a></td>
                        <td>
                            <form action="{{ route('C2.delete', ['id' => $file->id]) }}" method="POST">
                                @csrf
                                @method('DELETE')

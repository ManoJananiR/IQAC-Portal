...
<html lang="en">
  ...
  <body>
   ...
   <div class="excel"><h3 style="margin: 5px 0px 20px 0px;">Excel Title<a href="{{ asset('asset\excel\Book1.xlsx') }}" download class="excelbutton">Download</a></h3></div>
    ...
    @endif
    <form action="{{ route('C6.upload') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <input type="file" name="file" id="fileToUpload" style="margin: 6px 0px 20px 10px; font-size: 22px;"><br>
    ...
    <h2 style="margin: 6px 0px 20px 0px;">Uploaded Files</h2>
    @if($files->isEmpty())
            ...
            <tbody>
                @foreach($files as $file)
                    <tr>
                        ...
                        <td><a href="{{ route('C6.view', ['id' => $file->id]) }}" class="v">View</a></td>
                        <td><a href="{{ route('C6.download', ['id' => $file->id]) }}" class="v">Download</a></td>
                        <td>
                            <form action="{{ route('C6.delete', ['id' => $file->id]) }}" method="POST">
                                @csrf
                                @method('DELETE')
